...
- Each price is a key in a Red-Black tree from the STL:std::map<> that holds a queue
- The queue is implemented as a linked list with STL-compliant iterators stored in a hash table for O(1) removal of orders in the queue
